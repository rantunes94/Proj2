...
<div id="chatter" class="chatter_home">
	...
	<div id="chatter_hero">
		...
		<?php else: ?>
			<h1><?php echo app('translator')->getFromJson('chatter::intro.headline'); ?></h1>
			<p><?php echo app('translator')->getFromJson('chatter::intro.description'); ?></p>
		<?php endif; ?>
	</div>
	    ...
	    <div class="row">
	    	...
	    	<div class="col-md-3 left-column">
	    		...
	    		<div class="chatter_sidebar">
					<button class="btn btn-primary" id="new_discussion_btn"><i class="chatter-new"></i> <?php echo app('translator')->getFromJson('chatter::messages.discussion.new'); ?>
						<a href="<?php echo e(route('chatter.discussion.create')); ?>">***</a></button>
	...
	<div id="new_discussion">
    	...
    	<form id="chatter_form_editor" action="/<?php echo e(Config::get('chatter.routes.home')); ?>/<?php echo e(Config::get('chatter.routes.discussion')); ?>" method="POST">
        	<div class="row">
	        	<div class="col-md-7">
		        	<!-- TITLE -->
	                <input type="text" class="form-control" id="title" name="title" placeholder="<?php echo app('translator')->getFromJson('chatter::messages.editor.title'); ?>" value="<?php echo e(old('title')); ?>" >
	            </div>
        	...
        	<div id="editor">
				...
				<?php elseif($chatter_editor == 'trumbowyg'): ?>
					<textarea class="trumbowyg" name="body" placeholder="<?php echo app('translator')->getFromJson('chatter::messages.editor.tinymce_placeholder'); ?>"><?php echo e(old('body')); ?></textarea>
				<?php endif; ?>
    		</div>
            ...
            <div id="new_discussion_footer">
            	<input type='text' id="color" name="color" /><span class="select_color_text"><?php echo app('translator')->getFromJson('chatter::messages.editor.select_color_text'); ?></span>
            	<button id="submit_discussion" class="btn btn-success pull-right"><i class="chatter-new"></i> <?php echo app('translator')->getFromJson('chatter::messages.discussion.create'); ?></button>
            	<a href="/<?php echo e(Config::get('chatter.routes.home')); ?>" class="btn btn-default pull-right" id="cancel_discussion"><?php echo app('translator')->getFromJson('chatter::messages.words.cancel'); ?></a>
